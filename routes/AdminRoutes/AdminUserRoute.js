...
router.route('/admin/bulkDeleteUser').post(authMiddleware.checkAdminAuthorization,AdminUserController.bulkDeleteUsers); //http://localhost:5000/AdminUser/admin/bulkDeleteUser
