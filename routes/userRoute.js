...
router.route('/favoritesMovieSeries').get(authMiddleware.authenticateToken,authController.getFavoriteMovieSeries);//http://localhost:5000/users/favoritesMovieSeries
